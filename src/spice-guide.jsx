...
const spices = [
  ...
  { name: "Za'atar", emoji: "🟢", flavor: "Herby, nutty, tangy blend", dishes: ["Flatbreads", "Grilled chicken", "Dips", "Roasted vegetables", "Labneh"], cuisines: ["Middle Eastern", "Lebanese", "Israeli"], tip: "Mix with olive oil and spread on bread before baking. Recipes vary by region.", color: "#556B2F", type: "spice", heat: 0, pairs: ["Sumac", "Oregano", "Sesame", "Thyme"] },
          ...
          <div className="card" key={item.name} style={{ background: cardBg }}>
            <div className="card-header">
              ...
              <div style={{ flex: 1 }}>
                ...
                {item.type === "spice" && <HeatIndicator level={item.heat} />}
              </div>
            </div>
